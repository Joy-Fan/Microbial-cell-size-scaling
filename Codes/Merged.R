...
Data <- read.csv("Merged_Data.csv", as.is=TRUE)
...
#Figure 
png(filename = "Merged_Breakpoint.jpg",width =1200, height =1000) 
...
summary(fit)
Coef_Merged_MesoB<-tidy(summary(fit))
Meso1$a<--0.19109
Meso1$E<-0.12432
Coef_Merged_MesoB$R2<-0.06813
Coef_Merged_MesoB$P<-0.0002579
Coef_Merged_MesoB$Superkingdom<-"Bacteria"
...
summary(fit)
Coef_Merged_MesoA<-tidy(summary(fit))
Meso2$E<--0.006618
Meso2$a<-0.187848
Coef_Merged_MesoA$P<-0.2062
Coef_Merged_MesoA$R2<-0.008104
Coef_Merged_MesoA$Superkingdom<-"Archaea"

#Merge the data Data_T2
Coef_Merged_M_Breakpoint<-rbind(Coef_Merged_MesoA,Coef_Merged_MesoB)
write.table(Coef_Merged_M_Breakpoint,"C:/Users/FAN/Desktop/Final/Tables/Coef_Merged_M_Breakpoint.csv",sep=",")
...
png(filename = "Merged_Breakpoint2.jpg",width =1200, height =1000)
...
Meso<-Meso%>%group_by(ConPhylum)%>%filter(length(ConPhylum)>2)
...
write.table (Data_M, file ="C:/Users/FAN/Desktop/Final/Tables/Data_Merged_phylum2.csv", sep =",")
write.table (Coef_M, file ="C:/Users/FAN/Desktop/Final/Tables/Coef_Merged_phylum2.csv", sep =",")

#Plot based on phylum
png(filename = "Merged_phylum2.jpg",width =1000, height =700) 
